...
export const metadata: Metadata = {
  title: "Community",
  description:
    "LynxDock is built in the open. Follow development on GitHub, watch the roadmap, read the blog, and register for early access.",
};
...
const channels = [
  ...
  {
    title: "Roadmap",
    text: "See what's shipping, what's active, and what's planned across the ecosystem.",
    href: "/roadmap/",
    external: false,
    cta: "View roadmap",
  },
  ...
  return (
    <>
      <PageHeader
        ...
        title="Community"
        description="LynxDock is early and built in the open. The best way to shape it right now is to follow along, try it, and tell us what your community needs."
      >
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        <SectionHeader
          ...
          title="Where LynxDock is being built"
          className="mb-10"
        />
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_1fr] lg:items-center">
            <div>
              ...
              <p className="mt-4 text-[15px] leading-relaxed text-[#9fb2ba]">
                ...
                roadmap, in the repositories, and on the blog. As the community
                grows, we'll add more places to gather. For now, GitHub and the
                roadmap are the best way in.
              </p>
            </div>
            <ul className="space-y-3 text-sm text-[#c3d0d6]">
              {[
                ...
                "Regular development updates on the blog",
