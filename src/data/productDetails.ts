...
export const productDetails: Record<string, ProductDetail> = {
  ...
  "lynxdock-host": {
    ...
    summary: "LynxDock Host is the companion app for running your own server. A guided setup and an owner console create and manage a self-hosted LynxDock community - members, roles, channels, invites, backups, connectivity, and voice - without config files or the terminal.",
    stage: "Server Ownership",
    status: "in-development",
    href: "/products/lynxdock-host/",
    intro: "The owner's console for LynxDock. Create a server, then run it from one place - an Overview command center with a health verdict and readiness score, plus members, roles, channels, a server profile, invites, backups, connectivity checks, diagnostics, and voice.",
    features: [
      { title: "Overview command center", description: "A health verdict, a readiness score, and one-click fixes - so you can see your server's state at a glance and act on what needs attention.", icon: "server" },
      { title: "Members, roles & channels", description: "Manage members and multi-role assignment, server-wide roles with capability tokens, and first-class text, voice, and tactical channels.", icon: "users" },
      { title: "Invites, backups & recovery", description: "Invite-gated membership, online backups and recovery points, and a server profile with icon, banner, rules, and a join preview.", icon: "shield" },
      { title: "Connectivity & diagnostics", description: "Make your server reachable with a real round-trip proof, understand double-NAT / CGNAT honestly, and manage voice/TURN and diagnostics.", icon: "bolt" },
    ],
    ctas: [
      { label: "Documentation", href: "/docs/self-hosting/", variant: "primary" },
