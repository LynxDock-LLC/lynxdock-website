...
export default function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center px-5 pb-16 pt-20 text-center sm:pt-28">
        ...
        <span className="hud-label mt-8 flex items-center gap-2 animate-fade-up">
          ...
          />
          The command center for organized communities
        </span>
        ...
        <p className="mt-5 max-w-xl text-[15px] leading-relaxed text-[#9fb2ba] animate-fade-up sm:text-base">
          The communication platform with a tactical operations center. Voice,
          chat, and screen share - plus a live command tree, wings, objectives,
          and ready checks. Self-hosted, private, and yours.
        </p>
